...
import com.fanjam.model.EventType;
...
class EventControllerTest {
    ...
    @MockBean private BandRepository bandRepository;
    @MockBean private EventBandInfoRepository eventBandInfoRepository;
    ...
    void testGetAllEventsReturnsList() throws Exception {
        ...
        e1.setType(EventType.FREE);

        Event e2 = new Event();
        e2.setId(2L);
        e2.setTitle("Jazz Evening");
        e2.setType(EventType.PAID);
